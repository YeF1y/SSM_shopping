				...
				<tr>
					<td>
						<div class="form-group">
							...
							<br>
							<div class="col-sm-6">
								<img src="../${good.cover}" width="200" height="200"/>
								<br>
								<br>
					...
					<td>
						<div class="form-group">
							<label for="input_file" class="">详情图片1</label> 
							<br>
							<div class="col-sm-6">
								<img src="../${good.image1}" width="200" height="200"/>
								<br>
								<br>
					...
					<td>
						<div class="form-group">
							<label for="input_file" class="">详情图片2</label> 
							<br>
							<div class="col-sm-6">
								<img src="../${good.image2}" width="200" height="200"/>
								<br>
								<br>
