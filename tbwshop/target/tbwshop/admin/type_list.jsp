...
<div class="container-fluid">
	...
	<form class="form-inline" action="typeSearch" id="serchform" method="post">
		<div class="form-group">
			<input type="text" class="form-control" id="name" name="name" placeholder="类目名称" style="width: 500px">
		</div>
	...
	<c:forEach var="type" items="${typeList}">
         <tr>
         	...
         	<td><p>${type.name}</p></td>
			<td>
				<a class="btn btn-primary" href="typeEdit?id=${type.id}" title="修改"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
				<a class="btn btn-danger" href="typeDelete?id=${type.id}" title="删除"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			</td>
       	</tr>
     </c:forEach>
