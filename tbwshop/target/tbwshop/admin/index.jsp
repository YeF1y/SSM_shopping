	...
	<div class="navbar navbar-duomi navbar-static-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="/Admin/index.jsp" id="logo">淘宝坊后台管理系统
				</a>
			</div>
		</div>
	</div>
			...
			<div class="col-md-2">
				<ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
					...
					<li><a href="adminList"> <i
							class="glyphicon glyphicon-credit-card"></i>账号管理
					</a></li>
					...
					<li><a href="orderList"> <i
							class="glyphicon glyphicon-cog"></i>订单管理
					</a></li>
					
					<li><a href="goodList"> <i
							class="glyphicon glyphicon-globe"></i>商品管理 
					</a></li>
<%--					<c:if test="${type eq '管理员'}">--%>
					<li><a href="typeList"> <i
							class="glyphicon glyphicon-calendar"></i>类目管理
					</a></li>
<%--					</c:if>--%>

					<li><a href="bb"> <i
							class="glyphicon glyphicon-calendar"></i>报表
					</a></li>

					<li><a href="person"> <i
							class="glyphicon glyphicon-calendar"></i>个人信息
					</a></li>
					<li><a href="logout2"> <i
							class="glyphicon glyphicon-calendar"></i> 注销账户
					</a></li>
					<!--  -->
					<li><a href="logout"> <i
			...
			<div class="col-md-10">
			    <c:if test="${pa eq 'admin_list'}">
					<%@include file="admin_list.jsp"%>
				</c:if>
				<c:if test="${pa eq 'admin_list_add'}">
					<%@include file="admin_add.jsp"%>
				</c:if>
				<c:if test="${pa eq 'admin_edit'}">
					<%@include file="admin_edit.jsp"%>
				</c:if>

				<c:if test="${pa eq 'order1'}">
				...
				<c:if test="${pa eq 'person'}">
					<%@include file="person.jsp"%>
				</c:if>

				<c:if test="${pa eq 'bb'}">
					<%@include file="baobiao.jsp"%>
				</c:if>
			</div>
		</div>
	</div>
