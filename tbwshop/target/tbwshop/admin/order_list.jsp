		...
		<div class="btn-group dropdown" id="dropdown">
		 <!--  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		  ...
		  <ul class="dropdown-menu">
		    ...
		    <li><a href="orderList?status=1">未付款</a></li>
		    <li role="separator" class="divider"></li>
		    <li><a href="orderList?status=2">已付款</a></li>
		    <li role="separator" class="divider"></li>
		    <li><a href="orderList?status=3">配送中</a></li>
		    <li role="separator" class="divider"></li>
		    <li><a href="orderList?status=4">已完成</a></li>
		  </ul>
		</div>
	</form>
         ...
         <tr>
			...
			<td>
				<c:if test="${order.status==2}">
					<a class="btn btn-success" href="orderDispose?id=${order.id}&status=${status}" title="发货"><span class="glyphicon glyphicon-paste" aria-hidden="true"></span></a>
				</c:if>
				<c:if test="${order.status==3}">
					<a class="btn btn-warning" href="orderFinish?id=${order.id}&status=${status}" title="结束订单"><span class="glyphicon glyphicon-check" aria-hidden="true"></span></a>
				</c:if>
				<a class="btn btn-danger" href="orderDelete?id=${order.id}&status=${status}" title="删除"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			</td>
       	</tr>
	</c:forEach>
