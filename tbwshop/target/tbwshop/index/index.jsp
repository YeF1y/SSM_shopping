...
<body>
	...
	<div style="width: 100%; height: 450px; background-color: #b17e56;text-align: center;background:url('../picture/2021.png')">
		<div class="banner1" id="b04" style="">
			<ul>
				<c:forEach var="top" items="${top1List}" end="4">
					<li>
						<a href="detail?goodid=${top.good.id}"> 
							<img class="lunbo" src="../${top.good.cover}" alt="${top.good.name}"  >
						</a>
						<a href="detail?goodid=${top.good.id}"> 
							<img style="margin-left:0px" class="lunbo" src="../${top.good.image1}" alt="${top.good.name}"  >
						</a>
					</li>
				</c:forEach>
			</ul>
	...
	<div class="gallery" style="background-color:#fbffc038">
		<div class="container">
			<div style="font-size:18px;" class="alert alert-danger">热销推荐</div>
			<div class="gallery-grids">
				<c:forEach var="top" items="${top2List}" end="5">
					<div class="col-md-4 gallery-grid glry-two">
						<a href="detail?goodid=${top.good.id}"> <img
							style="height: 350px" src="../${top.good.cover}"
							class="img-responsive" alt="${top.good.name}" width="350"
							height="350" />
						</a>
